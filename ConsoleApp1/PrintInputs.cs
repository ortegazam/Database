...
namespace CharacterCreation
{
    public class PrintInputs
    {
        ...
        public static void SaveToDatabase(CharacterClass horrorCharacter)
        {
                ...
                try
                {
                    string databaseConnecshun = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Zam\Documents\Finals\MainFile\ConsoleApp1\Database1.mdf;Integrated Security=True";
                ...
                /*    try
                    {
                        ...
                        case "1":
                            SqlConnection sqlConnectNiyo;
                           string databaseConnecshun = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Zam\Documents\Finals\MainFile\ConsoleApp1\Database1.mdf;Integrated Security=True";

                            sqlConnectNiyo = new SqlConnection(databaseConnecshun);
                            sqlConnectNiyo.Open();
